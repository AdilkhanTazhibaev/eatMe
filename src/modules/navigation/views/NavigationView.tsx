...
export const NavigationView: React.FC = ({ onClick }: { onClick: () => void }) => {
  const items: MenuEntry[] = [
    { id: 'home', label: 'Главная', to: '/', icon: <HomeSmile /> },
    { id: 'my', label: 'Мои доставки заказов', to: '', icon: <Hearts /> },
    { id: 'prog', label: 'Программы', to: '/programs-nutrition', icon: <BarChart /> },
    { id: 'hist', label: 'История заказов', to: '', icon: <FastBackward /> },
    { id: 'prof', label: 'Профиль', to: '', icon: <User /> },
    { id: 'help', label: 'Поддержка', to: '', icon: <Message /> },
  ]
