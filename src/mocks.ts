import type { Program, ProgramCard } from '@/modules/programs/types.ts'
...
export const programCards: ProgramCard[] = [
  ...
  },
  {
    id: 'premium',
    name: 'Премиум',
    description: 'Максимально разнообразное питание с десертами',
    kcal: 2800,
    mealsPerDay: 5,
    durationDays: 30,
    sets: 1,
  ...
  },
  {
    id: 'light',
    name: 'Лайт',
    description: 'Лёгкое питание для контроля веса',
    kcal: 1800,
    mealsPerDay: 4,
    durationDays: 7,
    sets: 1,
